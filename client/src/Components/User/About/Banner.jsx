        ...
        <>
            <div className="w-full bg-white overflow-visible">
                ...
                <div className="relative w-full h-[110vh] flex flex-col px-2">
                    ...
                    {/* Content Overlay */}
                    <div className="relative z-10 flex-1 flex flex-col md:justify-center items-center px-4 sm:px-6 lg:px-8 md:pt-0 pt-16" data-aos="fade" data-aos-duration="800">
                        {/* About Us Label */}
                        <div className="mb-4">
                    ...
                    <div className="relative -bottom-45 z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 md:block hidden" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div className="bg-black rounded-3xl p-3 md:p-8 z-10 relative md:hidden block px-3  -bottom-30 " data-aos="fade-up" data-aos-delay="200">
